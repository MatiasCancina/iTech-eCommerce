  ...
  return (
    <div className="fixed inset-0 z-10 flex justify-center items-center backdrop-blur-xl px-3">
      <form
        ...
        className="bg-darkBlue py-4 px-6 rounded-xl max-w-md w-full space-y-4"
      >
        ...
        <div className="flex flex-col space-y-3">
          <div className="flex justify-between">
            <button
              className="bg-white py-3 px-6 sm:px-10 text-darkBlue rounded-full"
              onClick={() => loginUser(values)}
            >
              Login
            </button>
            <button
              className="flex items-center bg-white py-3 px-6 text-darkBlue rounded-full"
              onClick={() => googleLogin()}
            >
          ...
          <button
            className="bg-white py-3 px-6  text-darkBlue rounded-full"
